  ...
  return (
    <div className="flex">
      ...
      <div className="ml-72 flex-1 p-8">
        ...
        <p className="text-gray-700">💻 <a href="https://github.com/michael-soucek" target="_blank" rel="noopener noreferrer" className="text-blue-600">github.com/michael-soucek</a></p>
        <p className="mt-4 text-gray-600">📍 New Richland, MN, USA</p>
      </div>
    </div>
  );
};
