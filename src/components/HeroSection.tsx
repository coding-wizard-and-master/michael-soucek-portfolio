  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-white overflow-hidden">
      ...
      <div className="relative text-center px-5 sm:px-6 max-w-3xl mx-auto w-full">
        ...
        {/* Eyebrow */}
        <p className="section-label mb-8 tracking-[0.22em]">
          Software Engineer · CVS Health · 3.5 Years Enterprise Experience
        </p>
        ...
        {/* Tagline */}
        <p className="text-slate-800 text-xl sm:text-2xl font-semibold leading-snug max-w-2xl mx-auto mb-6">
          Building enterprise Angular, React, and Next.js applications at production scale.
        </p>

        {/* Bio */}
        <p className="text-slate-500 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-10">
          3.5+ years delivering production web applications, internal tools, and healthcare
          scheduling workflows at CVS Health. I work across Angular, React, Next.js, TypeScript,
          REST APIs, accessibility, and reusable component systems — shipping features used by
          millions of CVS customers and internal pharmacy teams.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-semibold border border-slate-200 text-slate-700 hover:border-slate-400 hover:text-slate-900 px-6 py-3 rounded transition-colors"
          >
            View Resume
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" d="M7 17l9.293-9.293M17 17V8H8" />
            </svg>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-sm font-semibold border border-slate-200 text-slate-600 hover:text-blue-600 hover:border-blue-300 px-4 py-3 rounded transition-colors"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      {/* Scroll hint — decorative only */}
      <div aria-hidden="true" className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
